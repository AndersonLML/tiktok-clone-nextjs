            ...
            >
                ...
                <div className="lg:w-full w-[55px] mx-auto">
                    ...
                    <div className="lg:block hidden text-[11px] text-gray-500">
                        <p className="pt-4 px-2">About Newsroom EducaBrasil Shop Contact Careers ByteDance</p>
                        <p className="pt-4 px-2">EducaBrasil for Good Advertise Developers Transparency TikTok Rewards TikTok Browse TikTok Embeds</p>
                        <p className="pt-4 px-2">Help Safety Terms Privacy Creator Portal Community Guidelines</p>
                        <p className="pt-4 px-2">© 2023 EducaBrasil</p>
                    </div>
